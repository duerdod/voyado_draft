...
var n = require('react'),
  ...
  r = e(require('@jetshop/core/components/AuthContext/useAuth')),
...
var u = { loginPath: '/login', signupPath: '/signup', loginOnActivation: !0, manualActivation: !1 },
  c = {
            ...
            always: [
              {
                ...
                cond: function(e) {
                  return e.providerOptions.loginOnActivation;
                },
              },
              { target: 'no_action_required' },
            ],
...
function f(e) {
  var i = s.useHistory(),
    ...
    y = void 0 === v ? '' : v,
    N = a.useMachine(p(e), {
      context: { externalCustomerToken: encodeURIComponent(y) },
      services: {
        tryLogin: function(e) {
          return (function(e, n) {
            var i = n.callback;
  ...
  var S = {
    ...
    isActionPending:
      N.matches('checking_action_required') ||
      N.matches('action_required.try_activate') ||
      N.matches('action_required.activation_failed.status_response'),
  };
  return (
    n.useEffect(
      function() {
        S.isAdditionalDataRequired &&
          i.push(e.signupPath || '/signup', { customer: l({}, N.context.customer) });
      },
      [S.isAdditionalDataRequired]
    ),
    l({}, S)
...
var x,
  F = n.createContext({}),
  E = { activateOnLookup: !0, signInOnActivation: !1 },
                  ...
                  states: {
                    ...
                    activation_success: {
                      ...
                      states: {
                          ...
                          always: [
                            {
                              target: 'login',
                              cond: function(e) {
                                return e.lookupOptions.signInOnActivation;
                              },
                            },
                        ...
                        login_failed: { type: 'final' },
                        customer_created: { type: 'final' },
                      },
                    },
...
(exports.LookupMachine = L),
  ...
  (exports.useGlobalActivationStatus = function() {
    return (
      n.useContext(F) || Error('useGlobalActivationStatus cannot be used outside VoyadoProvider')
    );
  }),
      ...
      t = a.useMachine(L, {
        services: {
          externalLookup: function(e, i) {
            return (function(e, i) {
              return { client: n }.client
                .query({ query: N, variables: { key: e.data.key } })
                .then(function(e) {
                  return e.data;
                });
            })(i);
          ...
          personLookup: function(e) {
            return (function(e, i) {
              return { client: n }.client
                .query({ query: S, variables: { key: e.customer.emailAddress } })
                .then(function(e) {
                  return e.data;
                });
            })(e);
          ...
          login: function(e) {
            return Promise.resolve(i(e.customer.token));
          },
        },
        context: { customer: null, lookupOptions: l({}, E, {}, e) },
      }),
      s = t[0],
      d = t[1],
      u = {
        isActivationRequired: s.matches('lookup.lookup_success.activation.activation_required'),
        isActivationPending: s.matches('lookup.lookup_success.activation.activation_loading'),
        isActivationSuccess: s.matches(
          'lookup.lookup_success.activation.activation_success.customer_created'
        ),
        isPreExistingCustomer: s.matches('lookup.lookup_success.preexisting'),
        IsAdditionalDataRequired: s.matches('lookup.lookup_success.additional_data'),
        isNonExistingCustomer: s.matches('lookup.lookup_success.non_existing'),
        isPersonLookupPending: s.matches(
          'lookup.lookup_success.non_existing.person_lookup_loading'
        ),
        hasPersonLookupData: s.matches('lookup.lookup_success.non_existing.person_lookup_success'),
        error: {
          lookupError: s.matches('lookup.lookup_failed'),
          activationError: s.matches('lookup.lookup_success.activation.activation_failed'),
          errorMessage: s.context.activationError,
        },
      };
    return (
      console.log('VoyadoLookupState: ', JSON.stringify(s.value)),
      l(
        {
          lookup: function(e) {
