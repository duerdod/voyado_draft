...
(exports.LookupMachine = L),
  ...
  (exports.useVoyadoLookup = function(e) {
    var n = o.useApolloClient(),
      ...
      d = t[1],
      u = {
        isActivationRequired: r.matches('lookup.lookup_success.activation.activation_required'),
        isActivationPending: r.matches('lookup.lookup_success.activation.activation_loading'),
        isActivationSuccess: r.matches(
          'lookup.lookup_success.activation.activation_success.customer_created'
        ),
        isPreExistingCustomer: r.matches('lookup.lookup_success.preexisting'),
        IsAdditionalDataRequired: r.matches('lookup.lookup_success.additional_data'),
        isNonExistingCustomer: r.matches('lookup.lookup_success.non_existing'),
        isPersonLookupPending: r.matches(
          'lookup.lookup_success.non_existing.person_lookup_loading'
        ),
        hasPersonLookupData: r.matches('lookup.lookup_success.non_existing.person_lookup_success'),
        error: {
          lookupError: r.matches('lookup.lookup_failed'),
          activationError: r.matches('lookup.lookup_success.activation.activation_failed'),
          errorMessage: r.context.activationError,
        },
      };
    return (
      console.log('VoyadoLookupState: ', JSON.stringify(r.value)),
      console.log('VoyadoLookupState: ', r.context),
      l(
        {
          lookup: function(e) {
