...
function _(e) {
  var n = o.useApolloClient(),
    i = r.useLocation().search,
    t = d(),
    u = t.loggedIn,
    c = t.logIn,
    m = s.parse(i, { ignoreQueryPrefix: !0 }).eclub,
    k = void 0 === m ? '' : m,
    g = a.useMachine(v(e), {
  ...
  return (
    console.log('GlobalActivationState: ', JSON.stringify(g.value)),
    l(
      {},
      {
        isAdditionalDataRequired: g.matches('action_required.activation_failed.additional_data'),
        isNonExistingCustomer: g.matches('action_required.activation_failed.non_existing'),
        isActivationRequired: g.matches('action_required.activation_failed.already_activated'),
      }
    )
  );
}
