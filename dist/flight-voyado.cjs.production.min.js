...
function g(e) {
  ...
  console.log(JSON.stringify(g.value));
  var y = {
    isAdditionalDataRequired: g.matches('action_required.activation_failed.additional_data'),
  };
  return l({ isCoolCustomer: g.context.providerSettings.isCoolCustomer }, y);
}
var y,
  S = n.createContext({}),
  ...
  f = t.assign({
    customer: function(e, n) {
      return l({}, e.customer, { email: n.data.key });
    },
  }),
  x = t.assign({
    customer: function(e, n) {
      ...
      return (
        ...
        ? void 0
        : null === (t = i.activateExternalCustomerByToken) || void 0 === t
        ? void 0
        : t.customer)
          ? l({}, e.customer, {}, n.data.activateExternalCustomerByToken.customer, {
              streetName: n.data.activateExternalCustomerByToken.customer.address,
              mobilePhone: n.data.activateExternalCustomerByToken.customer.mobilePhoneNumber,
            })
          : l({}, e.customer)
      );
    },
  ...
  E = t.assign({
    customer: function(e, n) {
      var i;
      if (null == n ? void 0 : null === (i = n.data) || void 0 === i ? void 0 : i.personLookup)
        return l({}, n.data.personLookup);
    },
  }),
  F = t.assign({
    customer: function(e, n) {
...
(exports.LookupMachine = A),
  ...
  (exports.useGlobalActivation = g),
  (exports.useVoyadoLookup = function(e) {
    var n = o.useApolloClient(),
      i = a.useMachine(A, {
        services: {
          externalLookup: function(e, i) {
            return n.query({ query: T, variables: { key: i.data.key } }).then(function(e) {
              return e.data;
            });
          },
          ...
          personLookup: function(e) {
            return n.query({ query: I, variables: { key: e.customer.email } }).then(function(e) {
              return e.data;
            });
          },
        },
