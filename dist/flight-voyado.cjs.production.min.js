...
function _(e) {
  var i = r.useHistory(),
    ...
    m = c.loggedIn,
    k = c.logIn,
    g = d.parse(u, { ignoreQueryPrefix: !0 }).eclub,
    N = void 0 === g ? '' : g,
    S = a.useMachine(v(e), {
  ...
  console.log('GlobalActivationState: ', JSON.stringify(S.value));
  var _ = {
    isAdditionalDataRequired: S.matches('action_required.activation_failed.additional_data'),
    isNonExistingCustomer: S.matches('action_required.activation_failed.non_existing'),
    isActivationRequired: S.matches('action_required.activation_failed.already_activated'),
    isActionPending:
      S.matches('checking_action_required') ||
      S.matches('action_required.try_activate') ||
      S.matches('action_required.activation_failed.status_response'),
  };
  return (
    n.useEffect(
      function() {
        _.isAdditionalDataRequired &&
          i.push(e.signupPage || '/signup', { customer: l({}, S.context.customer) });
      },
      [_.isAdditionalDataRequired]
    ),
    l({}, _)
...
var f,
  ...
  T = t.Machine(
            ...
            lookup_success: {
              ...
              states: {
                status_response: {
                  on:
                    ((f = {}),
                    (f.ACTIVATION_REQUIRED = '#activation'),
                    (f.PREEXISTING_CUSTOMER = '#preexisting'),
                    (f.ADDITIONAL_USER_DATA_REQUIRED = '#additional_data'),
                    (f.NON_EXISTING_CUSTOMER = '#non_existing'),
                    f),
                },
                activation: {
                  id: 'activation',
    ...
    {
      actions: {
        sendLookupSuccessEvent: F,
        setActivationError: h,
        storeEmail: E,
        storeCustomer: A,
        storeToken: b,
        storeLookupData: C,
...
(exports.LookupMachine = T),
  (exports.VoyadoContext = x),
  (exports.VoyadoProvider = function(e) {
    var n = _(l({}, e.settings));
    return i.createElement(x.Provider, Object.assign({ value: n }, e));
  }),
  (exports.createActivationMachine = v),
  (exports.defaultContext = { activateOnLookup: !1 }),
  (exports.useGlobalActivation = _),
  (exports.useGlobalActivationValues = function() {
    return (
      n.useContext(x) || Error('useGlobalActivationValues cannot be used outside VoyadoProvider')
    );
  }),
